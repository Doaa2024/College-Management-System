            ...
            <li class="nav-item">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?php if ($currentPage == 'control_course.php') echo 'page_selected'; ?>" href="control_course.php">
                            <i class="fas fa-book"></i>
                            Courses Info</a>
                        <a class="collapse-item <?php if ($currentPage == 'major_courses.php') echo 'page_selected'; ?>" href="major_courses.php?branchId">
                            <i class="fas fa-graduation-cap"></i>
                            Edit Major Courses </a>
                    </div>
                </div>
            </li>
