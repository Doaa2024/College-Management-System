      ...
      <div class="col-lg-6">
        ...
        <div style="display:flex">
          <div class="col-sm-4" >
            <div class="card" style="height: 170px;" >
              <div class="card-body text-center" >
                <div class="h5">Credits Remaining</div>
                <div class="display-4 font-weight-bold mb-4">62</div>
                <div class="progress progress-sm">
                  <div class="progress-bar bg-red" style="width: 98%"></div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-4" >
            <div class="card" style="height: 170px;">
              <div class="card-body text-center">
                <div class="h5">Credits <br> Earned</div>
                <div class="display-4 font-weight-bold mb-4" >42</div>
                <div class="progress progress-sm">
          ...
          <div class="col-sm-4" >
            <div class="card" style="height: 170px;">
              <div class="card-body text-center">
                <div class="h5">Courses Remaining</div>
                <div class="display-4 font-weight-bold mb-4" >42</div>
                <div class="progress progress-sm">
