...
$apply = new Apply();
$allCampus = $apply->getCampus();
$allDepartment = $apply->getDepartment();
$allFaculty = $apply->getFaculty();
?>
<style>
    h2 {
...
<body>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-header-inner animated zoomIn">
                        ...
                        <h1 class="display-1 text-dark">Apply Now
    ...
    <div class="con mt-5" style=" background-color: #ffffff;
        ...
        <form method="post" action="actions/submit_apply.php">
