...
<style>
    body {
        ...
        background-image: url('img/college36.webp');
    ...
    .form_main {
        ...
        border-radius: 40px;
        border: 1px solid rgba(241, 193, 82, .5);
        margin: 0 12px;
    ...
    .inputField:focus {
        outline: none;
        border-bottom: 2px solid rgba(241, 193, 82, 1);
    }
    ...
    #button:hover {
        background-color: rgba(217, 174, 74, 0.9);
    }
