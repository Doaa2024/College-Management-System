...
$branchHead = $dataRetrieval->getBranchHeadByBranchId($branchId);
$createdBy = $branchHead[0]['UserID'] ?? null; // Assuming this returns the 'UserID'
    ...
    <script>
        function showForm(type) {
            if (type) {
                ...
                alert(document.getElementById('newsletterTypeHidden').value);
